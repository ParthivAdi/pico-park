...
#
# Generated by export_simulation on Sun May 04 19:21:23 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './blue_rom.sh' script.

./blue_rom.sh -reset_run
...
./blue_rom.sh -noclean_files

For more information on the script, please type './blue_rom.sh -help'.
