...
#
# Generated by export_simulation on Sun May 04 19:19:57 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './spring_rom.sh' script.

./spring_rom.sh -reset_run
...
./spring_rom.sh -noclean_files

For more information on the script, please type './spring_rom.sh -help'.
