...
#
# Generated by export_simulation on Sun May 04 19:16:56 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './key_rom.sh' script.

./key_rom.sh -reset_run
...
./key_rom.sh -noclean_files

For more information on the script, please type './key_rom.sh -help'.
