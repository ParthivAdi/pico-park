...
HD_PWD='C:/Users/falli/385/lab6_1/lab6_1.runs/door_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log door_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source door_rom.tcl
