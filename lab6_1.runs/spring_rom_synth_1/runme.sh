...
HD_PWD='C:/Users/falli/385/lab6_1/lab6_1.runs/spring_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spring_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spring_rom.tcl
