...
HD_PWD='C:/Users/falli/385/lab6_1/lab6_1.runs/key_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_rom.tcl
